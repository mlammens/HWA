...
colnames(canopy) <- c("DEP_DEC_Site","Site","Plot","Stand_Health","North","East","South","West","Average")
colnames(ground_cover) <- c("DEP_DEC_Site","Site","Plot","Stand_Health","Species","Common","Native_or_Non_Native","Coverage","Notes")
colnames(hwa) <- c("DEP_DEC_Site","Site","Plot","Stand_Health","Tree","HWA","Transparency","LCR","Health_Value")
colnames(trees) <- c("DEP_DEC_Site","Site","Plot","Stand_Health","Species_Name","Common","DBH_cm","Notes")
...
```{r}
plot_sev <- hwa %>%
  group_by(Site, Plot, Stand_Health) %>%
  summarize(
